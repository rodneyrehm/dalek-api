...
Unit.prototype.queue = function() {
  ...
  if (this._item) {
    ...
    // FIXME: use this as a flag to make actions/assertions accessible
    // to other actions/assertions without going through the queue?
    // this would mean you're returning 
