...
module.exports = function(dalek) {
  ...
  dalek.addAction('selectQueryAware', function one(done, error, selector) {
    // this === unit
    console.log("running action one: " + selector);
    done()
  }, {query: true});
  
  dalek.addAction('selectQueryUnaware', function one(done, error, selector) {
    // this === unit
    console.log("running action one: " + selector);
    done();
  }, {query: false});
